...
(function(){
  ...
  bind('enlargeBtn', ()=>{ enlargeMode=!enlargeMode; $('canvasWrap').classList.toggle('enlargeMode', enlargeMode); $('enlargeBtn').classList.toggle('active', enlargeMode); if(!enlargeMode && loupe) loupe.hidden=true; });
})();
