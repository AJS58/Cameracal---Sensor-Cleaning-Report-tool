...
(function(){
  ...
  if (how) how.addEventListener('click', () => show('How it works', `
    <ol class="modalList">
      ...
      <li><b>Export as JPEG</b> and upload the image into the app.</li>
      <li><b>Run Auto Detect</b> to highlight visible dust, debris, smears or bonded contamination.</li>
      <li><b>Review the result</b> using the manual Add Mark and Erase tools if required.</li>
  ...
  if (help) help.addEventListener('click', () => show('Help', `
    ...
    <h3>Manual tools</h3>
    <p><b>Add Mark</b> allows you to click missed contamination. <b>Erase</b> removes a detected or manually added mark near the cursor. <b>Clear All</b> removes manual adjustments.</p>
    <h3>Report access</h3>
